...
function updatePositions() {
  ...
  // scrollTop doesn't need to be recalculated everytime
  var scrollTopDiv = document.documentElement.scrollTop / 1250;

  // getElementsByClassName for better performance
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // reduced animated pizzas
  console.log(window.innerWidth);
  var numP = 0;
  var windowInnWid = window.innerWidth;
  if (windowInnWid >= 1200) {
      numP = 64;
  } else if (windowInnWid >= 992) {
      numP = 48;
  } else if (windowInnWid >= 768) {
      numP = 32;
  } else {
      numP = 16;
  }
